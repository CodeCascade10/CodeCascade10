...
- 🤖 WhatsApp AI Chatbot (using LLM APIs + automation)  
- 🧠 Code RAG (Retrieval-Augmented Generation based system)  
- 🎯 AI Interview System  

👯 I’m looking to collaborate on  
- Backend projects (Node.js, APIs, system design)  
- AI-based real-world applications  

🤝 I’m looking for help with  
- Scaling backend systems 🚀  
- Optimizing AI API usage (cost + performance)  
